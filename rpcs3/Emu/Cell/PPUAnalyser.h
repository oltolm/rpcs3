...
struct ppu_module
{
	...
	bool analyse(u32 lib_toc, u32 entry, u32 end, const std::basic_string<char32_t>& applied, const std::vector<u32>& exported_funcs = std::vector<u32>{}, std::function<bool()> check_aborted = {});
...
struct main_ppu_module : public ppu_module
{
	u32 elf_entry{};
	u32 seg0_code_end{};
	std::basic_string<char32_t> applied_patches;
};
