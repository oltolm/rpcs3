...
public:
	...
	{
		u32 vaddr;
		std::basic_string<char32_t> inst_data;
...
protected:
	...
	std::unordered_map<u32, std::basic_string<char32_t>, value_hash<u32, 2>> m_targets;

	// List of block predecessors
	std::unordered_map<u32, std::basic_string<char32_t>, value_hash<u32, 2>> m_preds;
	...
	struct block_info
	{
		...
		std::basic_string<char32_t> targets;

		// All predeccessor blocks
		std::basic_string<char32_t> preds;
	};
	...
	std::basic_string<char32_t> m_chunks;
	...
	struct func_info
	{
		...
		// Call targets
		std::basic_string<char32_t> calls;
...
public:
	...
	spu_program analyse(const be_t<u32>* ls, u32 entry_point, std::map<u32, std::basic_string<char32_t>>* out_target_list = nullptr);
